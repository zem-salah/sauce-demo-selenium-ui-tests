...
def step_impl(context, user_pretty_name, page_pretty_name):
    """
    Access a page directly via URL using cookies to authenticate.
    :param user_pretty_name: User pretty name as defined in data/user
    :param page_pretty_name: Page pretty name as defined in
    page_object/page_factory
    :return:
    """
